...
class DDOSAttacks:
    ...
    def _get_attack_config(self):
        ...
        if target_type == "2":
            ...
            try:
                ...
                return self._get_attack_config()  # Retry
        else:
            # IP input
        ...
        # Auto-set port for HTTP attacks if not specified
    ...
    def _attack_worker(self, worker_id, end_time):
        """Worker thread for sending attack packets"""
    ...
    def _send_http_packet(self):
        ...
        # Use the actual URL if provided, otherwise use IP
    ...
    def _send_dns_packet(self):
        ...
        # Use the actual domain if provided, otherwise use a common one
    ...
    def _send_mixed_packet(self):
        """Mixed attack - random packet types"""
        attacks = [
            self._send_syn_packet,
            self._send_udp_packet, 
            self._send_icmp_packet,
